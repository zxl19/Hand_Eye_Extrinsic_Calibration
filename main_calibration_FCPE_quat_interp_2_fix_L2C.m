...
view(3)
%% Optimization
fun = @(x)costFunction_FCPE_quat_interp_2_fix_L2C(pose_1_interp_13, pose_3_interp_13, pose_2_interp_23, pose_3_interp_23, pose_1_interp_12, pose_2_interp_12, x_12, x);
