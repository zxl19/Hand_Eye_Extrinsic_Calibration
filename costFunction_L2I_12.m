function loss = costFunction_L2I_12(pose_1, pose_2, x0)
mu = [1, 1, 1e6, 1e6]; % weight
R = [x0(1, 4 : 6); x0(1, 7 : 9); x0(1, 10 : 12)];
t = x0(1, 1 : 3)';
loss = 0;
[n, ~] = size(pose_1);
for i = 2 : n
